...
const envSchema = z.object({
  ...
  VAPI_DEFAULT_VOICE_ID: z.string().default('marin'),
  VAPI_FALLBACK_VOICE_PROVIDER: z.string().default('openai'),
  VAPI_FALLBACK_VOICE_ID: z.string().default('cedar'),
...
const parsedEnv = envSchema.parse({
  ...
  VAPI_DEFAULT_VOICE_ID: process.env.VAPI_DEFAULT_VOICE_ID ?? 'marin',
  VAPI_FALLBACK_VOICE_PROVIDER: process.env.VAPI_FALLBACK_VOICE_PROVIDER ?? 'openai',
  VAPI_FALLBACK_VOICE_ID: process.env.VAPI_FALLBACK_VOICE_ID ?? 'cedar',
